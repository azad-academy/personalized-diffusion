...
with capture.capture_output() as cap:
    ...
    os.system("cd /content/personalized-diffusion/stable-diffusion-webui/")
...
with capture.capture_output() as cap:  
  if not os.path.exists('/content/personalized-diffusion/stable-diffusion/src/k-diffusion/k_diffusion'):
    ...
    os.system("cd /content/personalized-diffusion/stable-diffusion/src")
...
with capture.capture_output() as cap:
  if not os.path.exists('/usr/local/lib/python3.7/dist-packages/gradio-3.4b3.dist-info'):
    ...
    os.system("cd /content/personalized-diffusion/stable-diffusion-webui/ldm/modules")
    ...
    os.system("cd /content/personalized-diffusion/stable-diffusion-webui/modules")
